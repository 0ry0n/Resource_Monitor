...
const ResourceMonitorPrefsWidget = GObject.registerClass(
    class ResourceMonitorPrefsWidget extends Gtk.Box {
        ...
        _buildGlobal() {
            ...
            let leftClick = new RadioButtonRow(this._settings, LEFT_CLICK_STATUS, [_('Launch GNOME System Monitor'), _('Launch GNOME Usage'), _('Launch htop'), _('Launch btop')], ['gnome-system-monitor', 'gnome-usage', 'htop', 'btop']);
